...
set_target_properties(iDynTree::idyntree-modelio-urdf PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libidyntree-modelio-urdf.so"
  IMPORTED_SONAME_RELEASE "libidyntree-modelio-urdf.so"
  )

list(APPEND _IMPORT_CHECK_TARGETS iDynTree::idyntree-modelio-urdf )
list(APPEND _IMPORT_CHECK_FILES_FOR_iDynTree::idyntree-modelio-urdf "${_IMPORT_PREFIX}/lib/libidyntree-modelio-urdf.so" )
